...
<body>
                ...
                <span class="setas-atalho">
                    <</span>
                        <div class="atalhos">
                            ...
                            <div id="14-espessura" class="atalhos-btn atalhos-btn-azul">#2,25</div>
                            <div id="5-espessura" class="atalhos-btn atalhos-btn-azul-mod">#2,65</div>
                            <div id="6-espessura" class="atalhos-btn atalhos-btn-azul">#3,18(1/8)</div>
                            <div id="7-espessura" class="atalhos-btn atalhos-btn-azul-mod">#4,75(3/16)</div>
                            <div id="8-espessura" class="atalhos-btn atalhos-btn-azul">#6,35(1/4)</div>
                            <div id="9-espessura" class="atalhos-btn atalhos-btn-azul-mod">#7,94(5/16)</div>
                            <div id="10-espessura" class="atalhos-btn atalhos-btn-azul">#9,53(3/8)</div>
                            <div id="11-espessura" class="atalhos-btn atalhos-btn-azul-mod">#12,7(1/2)</div>
                            <div id="12-espessura" class="atalhos-btn atalhos-btn-azul">#15,88(5/8)</div>
                            <div id="13-espessura" class="atalhos-btn atalhos-btn-azul-mod">#19,05(3/4)</div>
                        </div>
    ...
    <h2 class="titulo footer-titulo">Sobre o projeto</h2>
